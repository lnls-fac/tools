...
__version__ = '$Id: 4f7e55a5edf2042a02ad34b3ceeaf28e2fcdc42f $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'vep', 'ay', 'sc', 'dv', 'so', 'zh-classical', 'nrm', 'rm', 'udm',
            'koi', 'kw', 'ug', 'stq', 'lad', 'wuu', 'lij', 'eml', 'fur', 'mt',
            'bh', 'as', 'cbk-zam', 'gn', 'pi', 'pcd', 'gag', 'ksh', 'nov',
            'szl', 'ang', 'ie', 'nv', 'ace', 'ext', 'frp', 'mwl', 'ln', 'sn',
            'dsb', 'lez', 'pfl', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw', 'myv',
